...
///
/// v26 added the follow-up queue: `Request::QueueInput`,
...
/// `queuedFollowUps: 26` entry, because a gate that only stops the send
...
pub fn min_version_for(req: &Request) -> u32 {
    match req {
        ...
        //
        // daemonCompat.ts still carries `queuedFollowUps: 26`, for the
...
mod tests {
    ...
    /// v26=4 (the follow-up queue), plus Unknown.
    #[test]
