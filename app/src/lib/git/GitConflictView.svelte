<script lang="ts">
  ...
  import { gitStore, saveConflict, markResolved, resolveWhole, restoreConflict, openMergeTool } from "$lib/git/gitState";
  import { parseConflicts, applyChoice, hasMarkers, locateRegion, splitEol, joinEol, type Choice, type ConflictBlock } from "$lib/git/conflictMarkers";
