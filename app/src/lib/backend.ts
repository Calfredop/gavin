...
import type { ApplyMode, CommitDetail, ConflictInfo, DiscardReport, FileDiff, FileEntry, InProgressKind, LogPage, RefsSnapshot, RepoInfo, ResetMode, RunChanges, StatusResult } from "$lib/git";
import type { ConflictNote, Orchestration, Rail, RailState, StepState } from "$lib/orchestration";
import type { ToolRecord } from "$lib/orchestrationTools";
import type { ToolRun } from "$lib/workspaceTools";
import type { GroupTemplateRecord } from "$lib/orchestrationGroups";
...
import type { ManagedSessions } from "$lib/sessionsManager";
