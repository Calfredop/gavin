<script lang="ts">
  ...
  import { describeConflict, conflictRailId } from "$lib/orchestration/orchestration";
  import { loadConflictsCollapsed, saveConflictsCollapsed } from "$lib/orchestration/orchestrationConflictBanner";
  import type { CardEntry, NumberedConflict, Orchestration } from "$lib/orchestration/orchestration";
  import type { Tool } from "$lib/orchestration/orchestrationTools";
  import { railBindFix, type RailBindTab } from "$lib/orchestration/railBind";
