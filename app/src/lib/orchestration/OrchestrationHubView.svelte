<script lang="ts">
  ...
  import RailBindDialog from "$lib/orchestration/RailBindDialog.svelte";
  ...
  import { templateFromStage } from "$lib/orchestration/orchestrationGroups";
  import GroupTemplateSaveDialog from "$lib/orchestration/GroupTemplateSaveDialog.svelte";
  import {
    orchestrations,
    fetchOrchestration,
